  ...
  const handleFromAmountChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value && !isNaN(parseFloat(value))) {
      const calculatedAmount = (
        (parseFloat(value) * fromToken.price) /
        toToken.price
      ).toFixed(6);
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          const token = cryptoOptions.find(
                            (t) => t.value === value
                          );
                  ...
                  <div className="mt-6">
                    ...
                    <div className="bg-muted/50 p-3 rounded-lg text-xs text-muted-foreground">
                      <div className="flex gap-2 items-start">
                        ...
                        <span>
                          SageSwap automatically routes your trade across
                          multiple exchanges to get the best price and lowest
                          fees.
                        </span>
                      </div>
                    </div>
